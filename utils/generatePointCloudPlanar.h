...
Vector3 generateRandomTranslationDefault( double maxAngle, const Vector3 & dir_rot); 
...
// generate random rotation with perturbation                               
...
Matrix3 generateYRotation( double maxAngle, const Vector3 & dir_parallax); 
